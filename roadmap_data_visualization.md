...
olist-dataviz/
├── docs/
│   ├── 01_discovery.md        # Aula 01 — perfil dos dados + perguntas de negócio
│   ├── 02_percepcao.md        # Aula 02 — auditoria perceptiva de um gráfico
│   ├── 03_numericos.md        # Aula 03 — justificativa das escolhas numéricas
│   ├── 04_categoricos.md      # Aula 04 — tratamento de categorias e texto
│   ├── 05_representacao.md    # Aula 05 — matriz de decisão da turma
│   ├── 06_mapas.md            # Aula 06 — decisões geoespaciais
│   ├── 07_kpis.md             # Aula 07 — ficha técnica dos indicadores
│   └── 08_narrativa.md        # Aula 08 — roteiro da apresentação
...
**Artefato:** coleção nomeada com 5 perguntas salvas + `docs/01_discovery.md` com o perfil dos dados e o backlog de perguntas.
...
**Artefato:** par antes/depois salvo na coleção + `docs/02_percepcao.md` relacionando cada alteração a um princípio perceptivo.
...
**Artefato:** 4 perguntas numéricas salvas, uma por tipo de trabalho + `docs/03_numericos.md`.
...
**Artefato:** 3 perguntas categóricas + uma análise textual + `docs/04_categoricos.md`.
...
**Artefato:** matriz de decisão consolidada + `docs/05_representacao.md`.
...
**Artefato:** 2 mapas com justificativa de normalização + `docs/06_mapas.md`.
...
**Artefato:** dashboard funcional com 4 KPIs e filtros + `docs/07_kpis.md` com a ficha técnica de cada indicador.
...
**Artefato:** dashboard narrativo + `docs/08_narrativa.md` + exportação completa da coleção.
...
1. **Conceito** — bloco teórico introduz o framework da semana.
2. **Pergunta** — o aluno escolhe uma pergunta do backlog criado na Aula 01.
3. **Construção** — implementa a resposta no Metabase.
4. **Crítica** — revisão por pares com foco em percepção, não em estética.
5. **Justificativa** — registra em `docs/NN_*.md` por que aquela representação e não outra.
6. **Curadoria** — organiza o artefato na coleção com o seu nome.
...
Critério transversal: toda escolha de representação precisa de justificativa explícita. Trabalho sem justificativa é avaliado como incompleto, ainda que visualmente correto.
